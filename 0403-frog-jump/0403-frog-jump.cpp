...
//         return recurse(0, stones, 0, cache, stoneMap); // two changing parameters 1. index of stone 2. size of the prev jump
//     }
// private:
//     bool recurse(int idx, vector<int>& stones, int prevJump, vector<vector<int>>& cache, unordered_map<int, int> stoneMap) {
...
//                 res = res || recurse(stoneMap[stones[idx] + nextJump], stones, nextJump, cache, stoneMap);
//             }
//         }
